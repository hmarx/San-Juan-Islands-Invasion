...
sigMFDSeed = cbind("Island"=seedmass[,"Row.names"],"Size.cat"=as.character(seedmass[,"Size.cat"]), "Metric"=rep(x = "MFD Seed Mass", times = nrow(seedmass)), "p.value" = seedmass[,"t.MFD.p.value"], "Area"=as.character(seedmass[,"Area.m2"]),  "sig"=ifelse(seedmass[,"t.MFD.p.value"] <= 0.05, 1,0))
...
sigMFDheight = cbind("Island"=height[,"Row.names"],"Size.cat"=as.character(seedmass[,"Size.cat"]), "Metric"=rep(x = "MFD Height", times = nrow(height)), "p.value" = height[,"t.MFD.p.value"], "Area"=as.character(height[,"Area.m2"]),  "sig"=ifelse(height[,"t.MFD.p.value"] <= 0.05, 1,0))
...
sigMFDSLA = cbind("Island"=SLA[,"Row.names"],"Size.cat"=as.character(seedmass[,"Size.cat"]), "Metric"=rep(x = "MFD SLA", times = nrow(SLA)),"p.value" = SLA[,"t.MFD.p.value"], "Area"=as.character(SLA[,"Area.m2"]),  "sig"=ifelse(SLA[,"t.MFD.p.value"] <= 0.05, 1,0))
...
sigMFDleaflet = cbind("Island"=leaflet[,"Row.names"],"Size.cat"=as.character(seedmass[,"Size.cat"]), "Metric"=rep(x = "MFD Leaf Size", times = nrow(leaflet)),"p.value" = leaflet[,"t.MFD.p.value"], "Area"=as.character(leaflet[,"Area.m2"]),  "sig"=ifelse(leaflet[,"t.MFD.p.value"] <= 0.05, 1,0))
...
sigMFDleafN = cbind("IleafNnd"=leafN[,"Row.names"],"Size.cat"=as.character(seedmass[,"Size.cat"]), "Metric"=rep(x = "MFD Leaf N", times = nrow(leafN)),"p.value" = leafN[,"t.MFD.p.value"], "Area"=as.character(leafN[,"Area.m2"]), "sig"=ifelse(leafN[,"t.MFD.p.value"] <= 0.05, 1, 0))
